...
Route::group(['prefix'=>'admin'],function(){
    Route::get('login',['uses'=>'AdminController@showFormLogin','as'=>'admin.login']);
    Route::post('login',['uses'=>'AdminController@login','as'=>'admin.handle.login']);
    Route::get('logout',['uses'=>'AdminController@logout','as'=>'admin.logout']);
    // Dashboard
	Route::get('dashboard',['uses'=>'DashboardController@index','as'=>'dashboard']);
    Route::post('ajax-change-status-order','DashboardController@changeStatusOrderAjax')->name('status.order');
    // Category
    ...
    // Admin
    Route::group(['prefix'=>'admin'],function(){
        Route::get('list',['uses'=>'AdminController@index','as'=>'admin.list']);

        Route::get('edit/{id}',['uses'=>'AdminController@edit','as'=>'admin.edit.form']);

		Route::post('edit/{id}',['uses'=>'AdminController@update','as'=>'admin.edit']);

        Route::get('add',['uses'=>'AdminController@create','as'=>'admin.add.form']);

        Route::post('add',['uses'=>'AdminController@store','as'=>'admin.add']);

        Route::get('delete/{id}',['uses'=>'AdminController@destroy','as'=>'admin.delete']);
	});
    // Brand
