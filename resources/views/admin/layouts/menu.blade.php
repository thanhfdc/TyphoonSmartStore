<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            @if (Session::get('admin')->role == 0 || Session::get('admin')->role == 2)
            <li>
            ...
            @endif
            @if (Session::get('admin')->role == 0)
            <li>
                <a href="#"><i class="fa fa-user" aria-hidden="true"></i> Nhân viên, quản lý<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{ route('admin.list') }}">Danh sách</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.add.form') }}">Thêm mới</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            @if (Session::get('admin')->role == 1 || Session::get('admin')->role == 0)
            <li>
