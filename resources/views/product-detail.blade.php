        ...
        <div class="col-lg-9">
            ...
            <div class="row mt-4 mb-3">
                <div class="col-md-6 sp-large">
                    <a href=""><img class="show_img_default" src="{{ asset('storage/images/products/'.$product['image_path']) }}" alt="{{ $product['id'] }}"
                            alt=""></a>
                    @if(count($imgDetail) > 0)
                        <div class="col-12 d-flex mt-3 container_img">
                            @foreach($imgDetail as $img)
                                <div class="box-img mr-3" style="width: 100px">
                                    <img class="img_src" src="{{ asset('storage/images/products/'.$img['path_image']) }}" alt="">
                                </div>
                            @endforeach
                        </div>
                    @endif
...
@endsection
    ...
    <script>
        $(document).ready(function (){
            $('.container_img .box-img').click(function (){
                let get = $(this).find('.img_src').attr('src')
                $('.col-md-6 .show_img_default').attr('src' , get)
            })
        })
    </script>
